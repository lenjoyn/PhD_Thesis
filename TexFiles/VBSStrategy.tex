...
\end{itemize}
The notations used here are the same as the ones used in Chap.~\ref{Chap:intro} with $\sigma^j$ as the Pauli Matrices, and they all have the same dimension of two:
\begin{equation}
...
\end{table}
\begin{table}[t]
	\caption{Summary of the selection criteria of of the resolved analysis for the $WW$ and $WZ$ signal regions (SR), $W$+jets control region (WR) and $ t\bar{t}$ control region (TR). } \label{Tab:SRdefinitions_resolvedVBS}
	\begin{center}
		\resizebox{\textwidth}{!}{
